...
In addition to the previously implemented vulnerabilities, this application now includes:

- **Race Condition Vulnerability**: Intentional race condition in the banking system's withdrawal functionality. Multiple concurrent withdrawal requests can result in overdrafts and inconsistent account states.
  - Endpoint: `POST /api/withdraw`
  - Method: Non-atomic read-check-update sequence
  - Impact: Users can withdraw more money than available in their account
  - Test: Run `node simple_race_test.js` to demonstrate the vulnerability
...
2. Open your browser and navigate to:
   ...
   - Race condition demo: `http://localhost:3000/race_condition_demo.html`
